...
namespace Kocmoca
{
    ...
    public static class DesignData
    {
        ...
        public static readonly string[] Design = {
            ...
            "「普鲸」在过去皆生活在北极海的极深处，毛熊设计局看中其能承受高压环境的特性将其改造为重型宇航机，然而逗比界的宇航机在设计上越来越大，普鲸被迫改良为高速武装机体。", // 普鲸
            ...
            "第二赛季结束后，神隐许久的辣鸡设计局终于在新材料的研究中取得了重大突破，这项技术运用在「远古飞鱼」的鳞片上，其拥有特殊变化的自然频率可大幅提升护盾强度。", // 远古飞鱼
            "南方公园设计局盗取了格鲁实验室的「独角兽」设计图，这是一项打造超巨型宇航机的实验计划，它具备海量的第七元素，能在机甲周围产生更大量的护盾晶体。", // 玩具独角兽
            "「南瓜魅影」是万圣地区为了变装狂欢日而诞生的巅峰之作，新型的涡轮轴发动机能负担起庞大的机体，使得节庆保卫中心在重型机的发展上称霸逗比界。", // 南瓜魅影
            "为因应众多逗比势力陆续推出的新型超重型宇航机，南方公园设计局提出了「赏金猎人」计划，使用罕见的变异元素为侧翼增加防御，但相对地就会牺牲掉宇航机应有的速度。", // 赏金猎人
    ...
    public static class DubiData
    {
        ...
        public static readonly string[] Chief = {
            "戴夫", // 神偷机兵
            "维特尔", // 红牛能量
            "大毛", // 普鲸
            "阿楞", // 纸飞机
        ...
        public static readonly string[] ChiefResume = {
            ...
            "大毛作为后毛熊时代的老大，为了延续毛熊设计局一贯的作风，而成为战斗民族的首位宇航机飞行员，将与宇航机老将萌总一同参与第四赛季。", // 普鲸
            "Awesome-O 7000是辣鸡设计局从南方公园设计局招募的Awesome-O 4000的纸箱人兄弟，将搭配阿楞一同出战第四赛季。", // 纸飞机
        ...
        public static readonly string[] SecondResume = {
            "强化过後的变异小小兵变成更邪恶尊贵的紫色逗比，它们操作的神偷机兵更倾向於近距离与对手一同毁灭，故有邪恶机兵的称号。", // 神偷机兵
